	...
	void handleClick(const Common::String &name) override {
		...
		if (name == "FatesLair") {
			...
			if (showNoFates()) {
				...
				switch (quest) {
				case kCreteQuest:
					hints.push_back(TranscribedSound("m2220wa0", _s("The Minotaur's is where you need to be. Trapping him sets Daedalus free.")));
					hints.push_back(TranscribedSound("m2220wb0", _s("King Minos is the king of Crete. He's not the nicest man you meet.")));
					hints.push_back(TranscribedSound("m2220wc0", _s("The Minotaur is hard to beat. The one who's trying lives in Crete")));
					break;
				case kTroyQuest:
					hints.push_back(TranscribedSound("m2230wa0", _s("If Helen gets this note, our friend, the trojan war will quickly end.")));
					hints.push_back(TranscribedSound("m2230wb0", _s("Helen was a husband's joy but she's a prisonner inside Troy.")));
					hints.push_back(TranscribedSound("m2230wc0", _s("The trojan horse you cannot ride bust beware what's found inside")));
					break;
				case kMedusaQuest:
					if (persistent->_medisleShowFates) {
						hints.push_back(kMedusaOnceBeauty);
						hints.push_back(TranscribedSound("m2250wa0", _s("Medusa's curse is quite well known: she looks at you and you turn to stone")));
						hints.push_back(TranscribedSound("m2250wb0", _s("So be forewarned, it isn't wise to gaze into Medusa's eyes.")));
					}
					break;
				case kRescuePhilQuest:
					hints.push_back(TranscribedSound("m2240wa0", _s("To rescue Phil's an easy fix: just go across the river Styx")));
					hints.push_back(TranscribedSound("m2240wb0", _s("You know Phil, he loves the ladies. He'd be best beware of the evil ladies")));
					break;
				// To silence warning
				case kNoQuest:
				case kEndGame:
...
*/
  	...
  	bool handleClickWithItem(const Common::String &name, InventoryItem item) override {
		...
		if (name == "Perseus" && (
			...
			room->disableMouse();
			playPerseusAnimSpeech("m1240ba0", TranscribedSound("m1240na0", _s("No, you've got to put it in the frieze above me, hurry!")), 11053);
		}
	...
	void handleEvent(int eventId) override {
		...
		case 11064: // Right pan
			...
			break;
		case 11601:
			fatesShadowSpeech(TranscribedSound("m2120wa0", _s("Now it's time, the eyeball's mine")), 11602);
			break;
		case 11602:
			fatesShadowSpeech(TranscribedSound("m2120wb0", _s("I can't see, so give it to me")), 11603);
			break;
		case 11603:
			fatesShadowSpeech(TranscribedSound("m2120wc0", _s("You stupid lout. Let's go, look out")), 11604);
			break;
		case 11604:
		...
		case 11005:
			playPerseusAnimSpeech("m1140bb0",
					      TranscribedSound(
						      "m1140nb0",
						      _s("This is what happens when you don't follow instructions. "
		...
		case 11007:
			playPerseusAnimSpeech("m1140bc0", TranscribedSound(
						      "m1140nc0",
						      _s("Without that stuff, I'm gonna wind up as part of Medusa's latest rock collection")),
					      11008);
			break;
		case 11008:
			playPerseusAnimSpeech("m1140bd0", TranscribedSound("m1140nd0", _s("You gotta help me")), 11006);
			break;
		case 11009:
		...
		case 11015:
			...
			if (_lastPlacedItem == kSword)
				playPerseusAnimSpeech("m1180bc0", TranscribedSound("m1180nb0", _s("Thanks for the sword. Did you bring anything else?")), 11016);
			else
				playPerseusAnimSpeech("m1190bc0", TranscribedSound("m1190nb0", _s("Thanks for the shield. Did you bring anything else?")), 11016);
			break;
		case 11016:
		case 11025:
		case 11053:
		...
		case 11017:
			renderPerseus();
			playPerseusAnimSpeech("m1200ba0", TranscribedSound("m1200na0", _s("You're doing great but I still need three other weapons. The fates will know where they are. Go ask them. They're somewhere on the isle")), 11018);
			break;
		case 11018:
			finishPerseusAnim();
		...
		case 11024:
			renderPerseus();
			playPerseusAnimSpeech("m1250bb0", TranscribedSound("m1250nb0", _s("What about the last item?")), 11025);
			break;
		case 11020:
			renderPerseus();
			playPerseusAnimSpeech("m1250ba0",
					      TranscribedSound("m1250na0", _s("What about the other items?")), 11025);
			break;
		case 11027:
		...
		case 11039:
		case 11040:
			playPerseusAnimSpeech("m1290ba0", TranscribedSound("m1290na0", _s("Hey, that's the magic bag. Put it in the frieze above me")), 11041);
			break;
		case 11041:
			finishPerseusAnim();

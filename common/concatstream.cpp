...
ConcatReadStream::ConcatReadStream(Common::Array<Common::SharedPtr<Common::SeekableReadStream>> parentStreams) : _parentStreams(parentStreams), _totalSize(0), _linearPos(0), _volume(0), _volumePos(0), _err(false), _eos(false) {

...
class StringTestSuite : public CxxTest::TestSuite
{
	...
	void test_korean() {
		const byte utf8[] = {
			0xea, 0xb5, 0xad, 0xeb, 0xa6, 0xbd, 0xea, 0xb5,
			0xad, 0xec, 0x96, 0xb4, 0xec, 0x9b, 0x90, 0x2f,
			0xe5, 0x9c, 0x8b, 0xe7, 0xab, 0x8b, 0xe5, 0x9c,
			0x8b, 0xe8, 0xaa, 0x9e, 0xe9, 0x99, 
			0xa2, 0x00
		};

		const uint32 utf32[] = {
			0xad6d, 0xb9bd, 0xad6d, 0xc5b4, 0xc6d0, 0x002f, 0x570b, 0x7acb, 0x570b, 0x8a9e, 0x9662, 0
		};

		const byte uhc[] = {
			0xb1, 0xb9, 0xb8, 0xb3, 0xb1, 0xb9, 0xbe, 0xee,
			0xbf, 0xf8, 0x2f, 0xcf, 0xd0, 0xd8, 0xa1, 0xcf,
			0xd0, 0xe5, 0xde, 0xea, 0xc2, 0x00
		};
